...
public class DirectDrawer {
    ...
    public DirectDrawer(int texture)
    {
        ...
        //GLES32.glBindVertexArray(mRenderVAO);
        ...
        mProgram = GLES32.glCreateProgram();             // create empty OpenGL ES Program
        GLES32.glAttachShader(mProgram, vertexShader);   // add the vertex shader to program
        GLES32.glAttachShader(mProgram, fragmentShader); // add the fragment shader to program
        GLES32.glLinkProgram(mProgram);                  // creates OpenGL ES program executables
    }
    ...
    public void draw(float[] mtx)
    {
        ...
        mTextureCoordHandle = GLES32.glGetAttribLocation(mProgram, "inputTextureCoordinate");
        GLES32.glEnableVertexAttribArray(mTextureCoordHandle);
        
//        textureVerticesBuffer.clear();
//        textureVerticesBuffer.put( transformTextureCoordinates( textureVertices, mtx ));
//        textureVerticesBuffer.position(0);
        GLES32.glVertexAttribPointer(mTextureCoordHandle, COORDS_PER_VERTEX, GLES32.GL_FLOAT, false, vertexStride, textureVerticesBuffer);
        ...
        GLES32.glDisableVertexAttribArray(mTextureCoordHandle);
    }
