...
public class VerticalSplitBars extends IBarsRenderer {
    ...
    private Vector3f mFromColor = ColorUtil.parseColor(0xFF5F6D);;
    private Vector3f mToColor = ColorUtil.parseColor(0xFFC371);
    ...
    private void initData() {
        ...
        mBottomColor = ColorUtil.parseColor(0xFFC371);
        mTopColor = ColorUtil.parseColor(0xFFC371);
